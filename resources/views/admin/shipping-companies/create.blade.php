    ...
    <div class="card card-color">
        <form action="{{ route('admin.shipping-companies.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <x-input id="district" class="w-full mt-1" placeholder="Huancayo" name="district" value="{{ old('district') }}"/>
            </div>
            ...
            <div class="mb-4">
                ...
                <x-input id="street" class="w-full mt-1" placeholder="Jr. los claves #2021" name="street" value="{{ old('street') }}"/>
            </div>
            ...
            <div class="mb-4">
                ...
                <x-input id="reference" class="w-full mt-1" placeholder="Cerca al parque Túpac" name="reference" value="{{ old('reference') }}"/>
            </div>
